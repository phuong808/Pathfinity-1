    ...
    try {
        ...
        if (process.env.RESEND_API_KEY && process.env.RESEND_API_KEY !== 'your_resend_api_key_here') {
            ...
            try {
                ...
                const { Resend } = await __turbopack_context__.A("[project]/node_modules/resend/dist/index.mjs [app-ssr] (ecmascript, async loader)");
...
function VerifyEmailPage() {
    ...
    const handleVerifyCode = async (e)=>{
        ...
        try {
            ...
            const signupResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signUp.email({
                email,
                password,
                name
            });
            if (!signupResult.error) {
                ...
                const signinResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                    email,
                    password
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__83717b92._.js.map