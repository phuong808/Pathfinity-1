...
async function sendVerificationEmail(email, code) {
    try {
        ...
        console.log('API Key exists:', !!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.RESEND_API_KEY);
        console.log('API Key starts with re_:', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.RESEND_API_KEY?.startsWith('re_'));
        // Check if we have a Resend API key
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.RESEND_API_KEY && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.RESEND_API_KEY !== 'your_resend_api_key_here') {
            console.log('🚀 Using Resend to send email...');
            try {
                // Use Resend for actual email sending
                const { Resend } = await __turbopack_context__.A("[project]/node_modules/resend/dist/index.mjs [app-client] (ecmascript, async loader)");
                const resend = new Resend(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.RESEND_API_KEY);
                ...
                if (!isTestEmail) {
                    console.log('⚠️  Email not in verified test list. Using development mode for:', email);
                    console.log('📧 To send real emails, verify a domain at https://resend.com/domains');
                    console.log('✅ Verified test emails:', verifiedTestEmails.join(', '));
                    // Use development mode for non-verified emails
                    console.log(`\n=== EMAIL VERIFICATION (DEV MODE) ===`);
                    console.log(`To: ${email}`);
                    console.log(`Verification Code: ${code}`);
                    console.log(`⚠️  Using dev mode - add ${email} to verified list or verify domain`);
                    console.log(`=====================================\n`);
                    return true;
                }
                console.log('📧 Sending email via Resend to verified email...');
          ...
          `
                ...
                if (result.error) {
                    ...
                    if (result.error.message && result.error.message.includes('testing emails')) {
                        console.log('⚠️  Resend API is in test mode - emails can only be sent to verified addresses');
                        console.log('📧 For testing, try using: phuong9@hawaii.edu');
                    ...
                    console.log(`To: ${email}`);
                    console.log(`Verification Code: ${code}`);
                    console.log(`⚠️  Resend API failed, using dev mode fallback`);
                    console.log(`=====================================\n`);
                    return true;
                }
                console.log(`✅ Verification email sent successfully to ${email} via Resend`);
            ...
            console.log(`To: ${email}`);
            console.log(`Verification Code: ${code}`);
            console.log(`⚠️  To send real emails, add your RESEND_API_KEY to .env.local`);
            console.log(`=====================================\n`);
        ...
        console.log('🔄 Using dev mode fallback due to error...');
        console.log(`\n=== EMAIL VERIFICATION (ERROR FALLBACK) ===`);
        console.log(`To: ${email}`);
        console.log(`Verification Code: ${code}`);
        console.log(`⚠️  Error occurred, using dev mode fallback`);
        console.log(`=====================================\n`);
        return true;
    }
}
...
function VerifyEmailPage() {
    ...
    const handleVerifyCode = async (e)=>{
        ...
        try {
            ...
            const signupResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signUp.email({
                email,
                password,
                name
            });
            if (!signupResult.error) {
                ...
                const signinResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
                    email,
                    password
                });
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "This verification link is invalid or has expired."
                    }, void 0, false, {
                        fileName: "[project]/app/verify-email/page.tsx",
                        lineNumber: 130,
                        columnNumber: 11
                ...
                isVerified && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: "Email verified successfully! Creating your account..."
                            }, void 0, false, {
                                fileName: "[project]/app/verify-email/page.tsx",
                                lineNumber: 167,
                                columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            ...
                            children: isVerified ? '✅ Verified! Creating account...' : isLoading ? 'Verifying...' : 'Verify Email'
                        }, void 0, false, {
                            fileName: "[project]/app/verify-email/page.tsx",
                            lineNumber: 196,
                            columnNumber: 11
...
_s(VerifyEmailPage, "zygYqkIGZjGrADL7O4FgPXgH6Ak=", false, function() {
    return [
...
//# sourceMappingURL=_1f6c26f3._.js.map