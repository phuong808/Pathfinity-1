...
function SidebarProvider({
  ...
  // Initialize from cookie (if present) so the sidebar preserves state across
  // page refreshes. The cookie is written as "true" or "false" by setOpen.
  const readSidebarCookie = React.useCallback(() => {
    try {
